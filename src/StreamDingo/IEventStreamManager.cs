...
public interface IEventStreamManager<TSnapshot> where TSnapshot : class
{
    ...
    public Task<TSnapshot?> ReplayAsync(string streamId, long fromVersion = 0, CancellationToken cancellationToken = default);
    ...
    public Task<TSnapshot?> GetCurrentStateAsync(string streamId, CancellationToken cancellationToken = default);
    ...
    public Task<Snapshot<TSnapshot>?> CreateSnapshotAsync(string streamId, long atVersion, CancellationToken cancellationToken = default);
    ...
    public Task<TSnapshot?> AppendEventAsync(string streamId, IEvent @event, long expectedVersion, CancellationToken cancellationToken = default);
}
